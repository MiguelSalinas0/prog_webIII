...
<body style="" class="">
	...
	<div style="left: 165px; width: 510px; position: absolute; top: 265px; height: 26px; z-index:1;"> <!--z-index:1; Es para superponer objetos -->
	<ul class="menu">
	<li> <a href="">
            <div>
	...
	<li><a href="">
		<p class="opcion">Facultades</p>
            ...
            <ul>
                ...
                <li><a class="subopcion" href="">Arte</a></li>
                <li><a class="subopcion" href="">Exactas</a>
                <li><a class="subopcion" href="">Filosofía</a>
                <li><a class="subopcion" href="">Ingeniería</a>
                    <ul>
